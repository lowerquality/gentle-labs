...
phnDict = {}
phones = open(sys.argv[1]+"/phones.txt","r+") # path to langdir where phones.txt resides
try:
...
with open(sys.argv[2] + "/phones.ctm","r+") as ctmFile: # path to phones.ctm file that is generated
